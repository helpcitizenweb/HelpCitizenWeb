...
<!-- Checkbox -->
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="5" class="w-full border-gray-300 rounded-lg shadow-sm" required></textarea>
        </div>

        <div>
            <label for="location" class="block text-gray-700 font-medium mb-1">Location / Address</label>
            <textarea name="location" id="location" rows="2" class="w-full border-gray-300 rounded-lg shadow-sm" placeholder="e.g. Purok 1, near barangay hall"></textarea>
        </div>
    ...
    <ul class="space-y-4">
        @forelse($reports as $report)
            <li class="p-4 border rounded shadow-sm bg-gray-50">
                ...
                <!-- Submission Info -->
                <p class="text-xs text-gray-500 mt-1">Submitted on: {{ $report->created_at->format('F j, Y g:i A') }}</p>
